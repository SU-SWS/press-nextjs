...
export type Query = {
  ...
  supBooksGraphql?: Maybe<SupBooksGraphqlResult>;
 ...
 * This acts as the public, top-level API from which all queries must start.
 */
export type QuerySupBooksGraphqlArgs = {
  contextualFilter?: InputMaybe<SupBooksGraphqlContextualFilterInput>;
  offset?: InputMaybe<Scalars['Int']['input']>;
  page?: InputMaybe<Scalars['Int']['input']>;
  pageSize?: InputMaybe<Scalars['Int']['input']>;
};
...
export type SupBooksGraphqlContextualFilterInput = {
  sup_book_work_id_number_value?: InputMaybe<Scalars['String']['input']>;
  term_node_taxonomy_name_depth?: InputMaybe<Scalars['String']['input']>;
};

/** Result for view sup_books display book_list_graphql. */
export type SupBooksGraphqlResult = View & {
  __typename?: 'SupBooksGraphqlResult';
  /** The description of the view. */
  description?: Maybe<Scalars['String']['output']>;
  /** The machine name of the display. */
  display: Scalars['String']['output'];
...
export type FragmentNodeSupBookTeaserFragment = { __typename: 'NodeSupBook', id: string, title: string, status: boolean, path: string, supBookImage?: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number } } | null, changed: { __typename?: 'DateTime', timezone: any, time: any }, created: { __typename?: 'DateTime', timezone: any, time: any } };

...
export type FragmentParagraphSupFileListFragment = { __typename: 'ParagraphSupFileList', supFileListLabel: string, id: string, behaviors?: string | null, supFileListFiles: Array<{ __typename: 'MediaFile', id: string, name: string, mediaFile: { __typename?: 'File', url: string } }> };
...
type FragmentParagraphUnion_ParagraphSupFileList_Fragment = { __typename: 'ParagraphSupFileList', id: string, behaviors?: string | null, supFileListLabel: string, supFileListFiles: Array<{ __typename: 'MediaFile', id: string, name: string, mediaFile: { __typename?: 'File', url: string } }> };

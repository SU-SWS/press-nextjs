...
export type NodeSupBook = EdgeNode & MetaTagInterface & NodeInterface & {
  ...
  /** Catalog Month */
  supBookCatalogMonth?: Maybe<Scalars['String']['output']>;
  /** Catalog Page */
  supBookCatalogPage?: Maybe<Scalars['String']['output']>;
  /** Catalog Season  */
  ...
  /** Copublisher? */
  supBookCopublisherYn?: Maybe<Scalars['Boolean']['output']>;
  /** Copyright Year */
  supBookCopyright?: Maybe<Scalars['Int']['output']>;
  /** Description */
  ...
  /** HTML Page Title */
  supBookHtmlPageTitle?: Maybe<Scalars['String']['output']>;
  /** Illustrations */
  supBookIllustrations?: Maybe<Scalars['String']['output']>;
  /** Book Image */
  supBookImage?: Maybe<MediaImage>;
  /** Imprint */
  supBookImprint?: Maybe<TermSupImprint>;
  /** In-Print Status */
  supBookInPrintStatus?: Maybe<Scalars['String']['output']>;
  /** Instructor Recommended */
  supBookInstructorRecommended?: Maybe<Scalars['String']['output']>;
  /** International Cart */
  ...
  /** Local Web Blurb */
  supBookLocalWebBlurb?: Maybe<Text>;
  /** New Paperback? */
  supBookNewPaperbackYn?: Maybe<Scalars['Boolean']['output']>;
  /** Pages */
  ...
  /** Price Digital */
  supBookPriceDigital?: Maybe<Scalars['Float']['output']>;
  /** Price Paper */
  ...
  /** Rights Description */
  supBookRightsDescription?: Maybe<Scalars['String']['output']>;
  /** Sales Rank */
  supBookSalesRank?: Maybe<Scalars['Float']['output']>;
  /** Series */
  supBookSeries?: Maybe<TermSupSeries>;
  /** Status Cloth */
  supBookStatusCloth?: Maybe<Scalars['String']['output']>;
  /** Status Digital */
  supBookStatusDigital?: Maybe<Scalars['String']['output']>;
  /** Status Paper */
  supBookStatusPaper?: Maybe<Scalars['String']['output']>;
  /** Book Subjects */
  supBookSubjects?: Maybe<Array<TermSupBookSubject>>;
  /** Subtitle */
  supBookSubtitle?: Maybe<Scalars['String']['output']>;
  /** Table of Contents */
  supBookTableOfContents?: Maybe<Text>;
  /** Type */
  supBookType: Scalars['String']['output'];
  /** URL ISW */
  supBookUrlIsw?: Maybe<Scalars['String']['output']>;
  /** Web Code Cloth */
  supBookWebCodeCloth?: Maybe<Scalars['String']['output']>;
  /** Web Code Paper */
  supBookWebCodePaper?: Maybe<Scalars['String']['output']>;
  /** Work ID */
...
/** Excerpts and More */
export type NodeSupBookSupBookExcerptsUnion = ParagraphStanfordCard | ParagraphStanfordGallery | ParagraphStanfordLayout | ParagraphStanfordSpacer | ParagraphStanfordWysiwyg | ParagraphSupFileList;
...
export type ParagraphSupCarouselSlide = LayoutParagraphsInterface & ParagraphInterface & {
  ...
  /** Choose a size of the body HTML on the slide. */
  supSlideBodySize: Scalars['String']['output'];
  /**
   * Directly reference a book and pull the image, title, and author automatically.
   * Begin typing the book title to see a list of choices.
   */
  supSlideBook?: Maybe<NodeSupBook>;
  /** Button */
...
export type ParagraphSupFileList = LayoutParagraphsInterface & ParagraphInterface & {
  ...
  /** Label */
  supFileListLabel: Scalars['String']['output'];
};
...
export type SupAward = MetaTagInterface & SupAwardInterface & {
  __typename?: 'SupAward';
  /** The Universally Unique IDentifier (UUID). */
  id: Scalars['ID']['output'];
  /** The computed meta tags for the entity. */
...
export type ParagraphQuery = { __typename?: 'Query', paragraph?: { __typename: 'ParagraphStanfordAccordion', id: string, behaviors?: string | null, suAccordionTitle: string, suAccordionBody: { __typename?: 'Text', processed?: any | null } } | { __typename: 'ParagraphStanfordBanner', id: string, behaviors?: string | null, suBannerHeader?: string | null, suBannerSupHeader?: string | null, suBannerBody?: { __typename?: 'Text', processed?: any | null } | null, suBannerButton?: { __typename?: 'Link', url?: string | null, title?: string | null } | null, suBannerImage?: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } } | null } | { __typename: 'ParagraphStanfordCard', id: string, behaviors?: string | null, suCardHeader?: string | null, suCardSuperHeader?: string | null, suCardBody?: { __typename?: 'Text', processed?: any | null } | null, suCardLink?: { __typename?: 'Link', url?: string | null, title?: string | null } | null, suCardMedia?: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } } | { __typename: 'MediaVideo', mediaOembedVideo: string, id: string, name: string } | null } | { __typename: 'ParagraphStanfordEntity', id: string, behaviors?: string | null, suEntityHeadline?: string | null, suEntityDescription?: { __typename?: 'Text', processed?: any | null } | null, suEntityButton?: { __typename?: 'Link', url?: string | null, title?: string | null } | null, suEntityItem?: Array<{ __typename?: 'NodeStanfordCourse', id: string, path: string } | { __typename?: 'NodeStanfordEvent', id: string, path: string } | { __typename?: 'NodeStanfordEventSeries', id: string, path: string } | { __typename?: 'NodeStanfordNews', id: string, path: string } | { __typename?: 'NodeStanfordPage', id: string, path: string } | { __typename?: 'NodeStanfordPerson', id: string, path: string } | { __typename?: 'NodeStanfordPolicy', id: string, path: string } | { __typename?: 'NodeStanfordPublication', id: string, path: string } | { __typename?: 'NodeSupBook', id: string, path: string }> | null } | { __typename: 'ParagraphStanfordGallery', id: string, behaviors?: string | null, suGalleryHeadline?: string | null, suGalleryDescription?: { __typename?: 'Text', processed?: any | null } | null, suGalleryButton?: { __typename?: 'Link', url?: string | null, title?: string | null } | null, suGalleryImages?: Array<{ __typename: 'MediaStanfordGalleryImage', suGalleryCaption?: string | null, id: string, name: string, suGalleryImage?: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number } | null }> | null } | { __typename: 'ParagraphStanfordLayout', id: string, behaviors?: string | null } | { __typename: 'ParagraphStanfordList', id: string, behaviors?: string | null, suListHeadline?: string | null, supListEyebrow?: string | null, suListDescription?: { __typename?: 'Text', processed?: any | null } | null, suListButton?: { __typename?: 'Link', url?: string | null, title?: string | null } | null, suListView: { __typename?: 'ViewReference', view: string, display: string, contextualFilter?: Array<string> | null, pageSize?: number | null } } | { __typename: 'ParagraphStanfordMediaCaption', id: string, behaviors?: string | null, suMediaCaptionMedia?: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } } | { __typename: 'MediaVideo', mediaOembedVideo: string, id: string, name: string } | null, suMediaCaptionLink?: { __typename?: 'Link', url?: string | null, title?: string | null } | null, suMediaCaptionCaption?: { __typename?: 'Text', processed?: any | null } | null } | { __typename: 'ParagraphStanfordPageTitleBanner', id: string, behaviors?: string | null } | { __typename: 'ParagraphStanfordPersonCtum', id: string, behaviors?: string | null } | { __typename: 'ParagraphStanfordSchedule', id: string, behaviors?: string | null } | { __typename: 'ParagraphStanfordSpacer', id: string, behaviors?: string | null, suSpacerSize?: string | null } | { __typename: 'ParagraphStanfordWysiwyg', id: string, behaviors?: string | null, suWysiwygText?: { __typename?: 'Text', processed?: any | null } | null } | { __typename: 'ParagraphSupAuthorList', id: string, behaviors?: string | null } | { __typename: 'ParagraphSupBlog', id: string, behaviors?: string | null } | { __typename: 'ParagraphSupBlogTeaser', id: string, behaviors?: string | null, supBlogTeaserHeader?: string | null, supBlogTeaserItems?: Array<{ __typename: 'ParagraphSupBlog', supBlogBody: string, supBlogTitle: string, id: string, behaviors?: string | null, supBlogImage: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } }, supBlogUrl: { __typename?: 'Link', title?: string | null, url?: string | null } }> | null, supBlogTeaserLink?: { __typename?: 'Link', title?: string | null, url?: string | null } | null } | { __typename: 'ParagraphSupCarousel', id: string, behaviors?: string | null, supCarouselTopHero?: boolean | null, supCarouselSlides: Array<{ __typename: 'ParagraphSupCarouselSlide', supSlideBodySize: string, supSlideColor?: string | null, supSlideEyebrow?: string | null, supSlideHide?: Array<string> | null, supSlideOrientation: string, supSlideSubtitle?: string | null, supSlideTitle?: string | null, supSlideTitleSize: string, id: string, behaviors?: string | null, supSlideBody?: { __typename?: 'Text', processed?: any | null } | null, supSlideBook?: { __typename?: 'NodeSupBook', id: string, title: string, path: string, supBookAuthorsFull?: string | null, supBookImage?: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } } | null, supBookLocalWebBlurb?: { __typename?: 'Text', processed?: any | null } | null } | null, supSlideButton?: { __typename?: 'Link', title?: string | null, url?: string | null } | null, supSlideImage?: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } } | null, supSlideBgImage: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } } }> } | { __typename: 'ParagraphSupCarouselSlide', id: string, behaviors?: string | null } | { __typename: 'ParagraphSupFileList', id: string, behaviors?: string | null, supFileListLabel: string, supFileListDisplay?: string | null, supFileListFiles: Array<{ __typename: 'MediaFile', id: string, name: string, mediaFile: { __typename?: 'File', url: string } } | { __typename: 'MediaSupProtectedFile', id: string, name: string, supMediaFile: { __typename?: 'File', url: string } }> } | { __typename: 'ParagraphSupSearchForm', id: string, behaviors?: string | null, supSearchBooksOnly?: boolean | null, supSearchSubject?: { __typename?: 'TermSupBookSubject', id: string, name: string } | null } | null };
...
export type FragmentSupAwardFragment = { __typename?: 'SupAward', id: string, name: string, supAssociation?: string | null, supPlace?: string | null, supRank?: number | null, supWorkId: number, supYear?: number | null, supDescription?: { __typename?: 'Text', processed?: any | null } | null };
...
export type FragmentMediaImageFragment = { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } };
...
type FragmentMediaUnion_MediaImage_Fragment = { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } };
...
type FragmentNodeInterface_NodeSupBook_Fragment = { __typename: 'NodeSupBook', id: string, title: string, status: boolean, path: string, changed: { __typename?: 'DateTime', timezone: any, time: any }, created: { __typename?: 'DateTime', timezone: any, time: any } };

type FragmentNodeInterface_NodeSupBookAncillary_Fragment = { __typename: 'NodeSupBookAncillary', id: string, title: string, status: boolean, path: string, changed: { __typename?: 'DateTime', timezone: any, time: any }, created: { __typename?: 'DateTime', timezone: any, time: any } };
...
export type FragmentNodeSupBookAncillaryFragment = { __typename: 'NodeSupBookAncillary', id: string, title: string, status: boolean, path: string, supAncillaryBook: { __typename: 'NodeSupBook', supBookSubtitle?: string | null, supBookAuthorsFull?: string | null, id: string, title: string, status: boolean, path: string, supBookImage?: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } } | null, changed: { __typename?: 'DateTime', timezone: any, time: any }, created: { __typename?: 'DateTime', timezone: any, time: any } }, supAncillaryParagraphs?: Array<{ __typename: 'ParagraphStanfordCard', id: string, behaviors?: string | null, suCardHeader?: string | null, suCardSuperHeader?: string | null, suCardBody?: { __typename?: 'Text', processed?: any | null } | null, suCardLink?: { __typename?: 'Link', url?: string | null, title?: string | null } | null, suCardMedia?: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } } | { __typename: 'MediaVideo', mediaOembedVideo: string, id: string, name: string } | null } | { __typename: 'ParagraphStanfordGallery', id: string, behaviors?: string | null, suGalleryHeadline?: string | null, suGalleryDescription?: { __typename?: 'Text', processed?: any | null } | null, suGalleryButton?: { __typename?: 'Link', url?: string | null, title?: string | null } | null, suGalleryImages?: Array<{ __typename: 'MediaStanfordGalleryImage', suGalleryCaption?: string | null, id: string, name: string, suGalleryImage?: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number } | null }> | null } | { __typename: 'ParagraphStanfordLayout', id: string, behaviors?: string | null } | { __typename: 'ParagraphStanfordSpacer', id: string, behaviors?: string | null, suSpacerSize?: string | null } | { __typename: 'ParagraphStanfordWysiwyg', id: string, behaviors?: string | null, suWysiwygText?: { __typename?: 'Text', processed?: any | null } | null } | { __typename: 'ParagraphSupFileList', id: string, behaviors?: string | null, supFileListLabel: string, supFileListDisplay?: string | null, supFileListFiles: Array<{ __typename: 'MediaFile', id: string, name: string, mediaFile: { __typename?: 'File', url: string } } | { __typename: 'MediaSupProtectedFile', id: string, name: string, supMediaFile: { __typename?: 'File', url: string } }> }> | null, changed: { __typename?: 'DateTime', timezone: any, time: any }, created: { __typename?: 'DateTime', timezone: any, time: any } };
...
export type FragmentNodeSupBookTeaserFragment = { __typename: 'NodeSupBook', supBookSubtitle?: string | null, supBookWorkIdNumber?: number | null, supBookAuthorsFull?: string | null, id: string, title: string, status: boolean, path: string, supBookAuthors?: Array<{ __typename?: 'NameType', title?: string | null, given?: string | null, middle?: string | null, family?: string | null, generational?: string | null, credentials?: string | null }> | null, supBookAwards?: Array<{ __typename?: 'SupAward', id: string, name: string, supAssociation?: string | null, supPlace?: string | null, supRank?: number | null, supWorkId: number, supYear?: number | null, supDescription?: { __typename?: 'Text', processed?: any | null } | null }> | null, supBookImage?: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } } | null, changed: { __typename?: 'DateTime', timezone: any, time: any }, created: { __typename?: 'DateTime', timezone: any, time: any } };
...
type FragmentNodeTeaserUnion_NodeSupBook_Fragment = { __typename: 'NodeSupBook', supBookSubtitle?: string | null, supBookWorkIdNumber?: number | null, supBookAuthorsFull?: string | null, id: string, title: string, status: boolean, path: string, supBookAuthors?: Array<{ __typename?: 'NameType', title?: string | null, given?: string | null, middle?: string | null, family?: string | null, generational?: string | null, credentials?: string | null }> | null, supBookAwards?: Array<{ __typename?: 'SupAward', id: string, name: string, supAssociation?: string | null, supPlace?: string | null, supRank?: number | null, supWorkId: number, supYear?: number | null, supDescription?: { __typename?: 'Text', processed?: any | null } | null }> | null, supBookImage?: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } } | null, changed: { __typename?: 'DateTime', timezone: any, time: any }, created: { __typename?: 'DateTime', timezone: any, time: any } };

type FragmentNodeTeaserUnion_NodeSupBookAncillary_Fragment = { __typename: 'NodeSupBookAncillary', id: string, title: string, status: boolean, path: string, changed: { __typename?: 'DateTime', timezone: any, time: any }, created: { __typename?: 'DateTime', timezone: any, time: any } };
...
type FragmentParagraphInterface_ParagraphSupAuthorList_Fragment = { __typename: 'ParagraphSupAuthorList', id: string, behaviors?: string | null };

type FragmentParagraphInterface_ParagraphSupBlog_Fragment = { __typename: 'ParagraphSupBlog', id: string, behaviors?: string | null };

type FragmentParagraphInterface_ParagraphSupBlogTeaser_Fragment = { __typename: 'ParagraphSupBlogTeaser', id: string, behaviors?: string | null };

type FragmentParagraphInterface_ParagraphSupCarousel_Fragment = { __typename: 'ParagraphSupCarousel', id: string, behaviors?: string | null };

type FragmentParagraphInterface_ParagraphSupCarouselSlide_Fragment = { __typename: 'ParagraphSupCarouselSlide', id: string, behaviors?: string | null };

type FragmentParagraphInterface_ParagraphSupFileList_Fragment = { __typename: 'ParagraphSupFileList', id: string, behaviors?: string | null };

type FragmentParagraphInterface_ParagraphSupSearchForm_Fragment = { __typename: 'ParagraphSupSearchForm', id: string, behaviors?: string | null };
...
export type FragmentParagraphStanfordListFragment = { __typename: 'ParagraphStanfordList', suListHeadline?: string | null, supListEyebrow?: string | null, id: string, behaviors?: string | null, suListDescription?: { __typename?: 'Text', processed?: any | null } | null, suListButton?: { __typename?: 'Link', url?: string | null, title?: string | null } | null, suListView: { __typename?: 'ViewReference', view: string, display: string, contextualFilter?: Array<string> | null, pageSize?: number | null } };

export type FragmentParagraphStanfordMediaCaptionFragment = { __typename: 'ParagraphStanfordMediaCaption', id: string, behaviors?: string | null, suMediaCaptionMedia?: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } } | { __typename: 'MediaVideo', mediaOembedVideo: string, id: string, name: string } | null, suMediaCaptionLink?: { __typename?: 'Link', url?: string | null, title?: string | null } | null, suMediaCaptionCaption?: { __typename?: 'Text', processed?: any | null } | null };
...
export type FragmentParagraphSupFileListFragment = { __typename: 'ParagraphSupFileList', supFileListLabel: string, supFileListDisplay?: string | null, id: string, behaviors?: string | null, supFileListFiles: Array<{ __typename: 'MediaFile', id: string, name: string, mediaFile: { __typename?: 'File', url: string } } | { __typename: 'MediaSupProtectedFile', id: string, name: string, supMediaFile: { __typename?: 'File', url: string } }> };

export type FragmentParagraphSupCarouselSlideFragment = { __typename: 'ParagraphSupCarouselSlide', supSlideBodySize: string, supSlideColor?: string | null, supSlideEyebrow?: string | null, supSlideHide?: Array<string> | null, supSlideOrientation: string, supSlideSubtitle?: string | null, supSlideTitle?: string | null, supSlideTitleSize: string, id: string, behaviors?: string | null, supSlideBody?: { __typename?: 'Text', processed?: any | null } | null, supSlideBook?: { __typename?: 'NodeSupBook', id: string, title: string, path: string, supBookAuthorsFull?: string | null, supBookImage?: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } } | null, supBookLocalWebBlurb?: { __typename?: 'Text', processed?: any | null } | null } | null, supSlideButton?: { __typename?: 'Link', title?: string | null, url?: string | null } | null, supSlideImage?: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } } | null, supSlideBgImage: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } } };

export type FragmentParagraphSupCarouselFragment = { __typename: 'ParagraphSupCarousel', supCarouselTopHero?: boolean | null, id: string, behaviors?: string | null, supCarouselSlides: Array<{ __typename: 'ParagraphSupCarouselSlide', supSlideBodySize: string, supSlideColor?: string | null, supSlideEyebrow?: string | null, supSlideHide?: Array<string> | null, supSlideOrientation: string, supSlideSubtitle?: string | null, supSlideTitle?: string | null, supSlideTitleSize: string, id: string, behaviors?: string | null, supSlideBody?: { __typename?: 'Text', processed?: any | null } | null, supSlideBook?: { __typename?: 'NodeSupBook', id: string, title: string, path: string, supBookAuthorsFull?: string | null, supBookImage?: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } } | null, supBookLocalWebBlurb?: { __typename?: 'Text', processed?: any | null } | null } | null, supSlideButton?: { __typename?: 'Link', title?: string | null, url?: string | null } | null, supSlideImage?: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } } | null, supSlideBgImage: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } } }> };

export type FragmentParagraphSupAuthorListFragment = { __typename: 'ParagraphSupAuthorList', id: string, behaviors?: string | null };

export type FragmentParagraphSupSearchFormFragment = { __typename: 'ParagraphSupSearchForm', supSearchBooksOnly?: boolean | null, id: string, behaviors?: string | null, supSearchSubject?: { __typename?: 'TermSupBookSubject', id: string, name: string } | null };

export type FragmentParagraphSupBlogFragment = { __typename: 'ParagraphSupBlog', supBlogBody: string, supBlogTitle: string, id: string, behaviors?: string | null, supBlogImage: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } }, supBlogUrl: { __typename?: 'Link', title?: string | null, url?: string | null } };

export type FragmentParagraphSupBlogTeaserFragment = { __typename: 'ParagraphSupBlogTeaser', supBlogTeaserHeader?: string | null, id: string, behaviors?: string | null, supBlogTeaserItems?: Array<{ __typename: 'ParagraphSupBlog', supBlogBody: string, supBlogTitle: string, id: string, behaviors?: string | null, supBlogImage: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } }, supBlogUrl: { __typename?: 'Link', title?: string | null, url?: string | null } }> | null, supBlogTeaserLink?: { __typename?: 'Link', title?: string | null, url?: string | null } | null };
...
type FragmentParagraphUnion_ParagraphStanfordList_Fragment = { __typename: 'ParagraphStanfordList', id: string, behaviors?: string | null, suListHeadline?: string | null, supListEyebrow?: string | null, suListDescription?: { __typename?: 'Text', processed?: any | null } | null, suListButton?: { __typename?: 'Link', url?: string | null, title?: string | null } | null, suListView: { __typename?: 'ViewReference', view: string, display: string, contextualFilter?: Array<string> | null, pageSize?: number | null } };
...
type FragmentParagraphUnion_ParagraphSupAuthorList_Fragment = { __typename: 'ParagraphSupAuthorList', id: string, behaviors?: string | null };

type FragmentParagraphUnion_ParagraphSupBlog_Fragment = { __typename: 'ParagraphSupBlog', id: string, behaviors?: string | null };

type FragmentParagraphUnion_ParagraphSupBlogTeaser_Fragment = { __typename: 'ParagraphSupBlogTeaser', id: string, behaviors?: string | null, supBlogTeaserHeader?: string | null, supBlogTeaserItems?: Array<{ __typename: 'ParagraphSupBlog', supBlogBody: string, supBlogTitle: string, id: string, behaviors?: string | null, supBlogImage: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } }, supBlogUrl: { __typename?: 'Link', title?: string | null, url?: string | null } }> | null, supBlogTeaserLink?: { __typename?: 'Link', title?: string | null, url?: string | null } | null };

type FragmentParagraphUnion_ParagraphSupCarousel_Fragment = { __typename: 'ParagraphSupCarousel', id: string, behaviors?: string | null, supCarouselTopHero?: boolean | null, supCarouselSlides: Array<{ __typename: 'ParagraphSupCarouselSlide', supSlideBodySize: string, supSlideColor?: string | null, supSlideEyebrow?: string | null, supSlideHide?: Array<string> | null, supSlideOrientation: string, supSlideSubtitle?: string | null, supSlideTitle?: string | null, supSlideTitleSize: string, id: string, behaviors?: string | null, supSlideBody?: { __typename?: 'Text', processed?: any | null } | null, supSlideBook?: { __typename?: 'NodeSupBook', id: string, title: string, path: string, supBookAuthorsFull?: string | null, supBookImage?: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } } | null, supBookLocalWebBlurb?: { __typename?: 'Text', processed?: any | null } | null } | null, supSlideButton?: { __typename?: 'Link', title?: string | null, url?: string | null } | null, supSlideImage?: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } } | null, supSlideBgImage: { __typename: 'MediaImage', id: string, name: string, mediaImage: { __typename?: 'Image', url: string, alt?: string | null, height: number, width: number, variations?: Array<{ __typename?: 'ImageStyleDerivative', url: string }> | null } } }> };

type FragmentParagraphUnion_ParagraphSupCarouselSlide_Fragment = { __typename: 'ParagraphSupCarouselSlide', id: string, behaviors?: string | null };

type FragmentParagraphUnion_ParagraphSupFileList_Fragment = { __typename: 'ParagraphSupFileList', id: string, behaviors?: string | null, supFileListLabel: string, supFileListDisplay?: string | null, supFileListFiles: Array<{ __typename: 'MediaFile', id: string, name: string, mediaFile: { __typename?: 'File', url: string } } | { __typename: 'MediaSupProtectedFile', id: string, name: string, supMediaFile: { __typename?: 'File', url: string } }> };

type FragmentParagraphUnion_ParagraphSupSearchForm_Fragment = { __typename: 'ParagraphSupSearchForm', id: string, behaviors?: string | null, supSearchBooksOnly?: boolean | null, supSearchSubject?: { __typename?: 'TermSupBookSubject', id: string, name: string } | null };

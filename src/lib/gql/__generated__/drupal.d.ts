...
export type ParagraphSupCarouselSlide = LayoutParagraphsInterface & ParagraphInterface & {
  ...
  /** Provide a chosen image instead of the image from the book (if one is selected). */
  supSupImage?: Maybe<MediaImage>;
};

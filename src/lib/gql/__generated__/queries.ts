...
export const AllNodesDocument = gql`
  query AllNodes(
    $first: Int = 1000
    $nodeSupBooks: Cursor
    $nodeStanfordCourses: Cursor
    $nodeStanfordEventSeriesItems: Cursor
    $nodeStanfordEvents: Cursor
    $nodeStanfordNewsItems: Cursor
    $nodeStanfordPages: Cursor
    $nodeStanfordPeople: Cursor
    $nodeStanfordPolicies: Cursor
    $nodeStanfordPublications: Cursor
  ) {
...
export const StanfordBasicPagesDocument = gql`
  query stanfordBasicPages(
    ...
    $sortKey: StanfordBasicPagesSortKeys
...
export const StanfordCoursesDocument = gql`
  query stanfordCourses(
    $contextualFilters: StanfordCoursesContextualFilterInput
    $pageSize: Int = -1
    $page: Int
    $offset: Int
  ) {
...
export const StanfordEventsDocument = gql`
  query stanfordEvents(
    $contextualFilters: StanfordEventsContextualFilterInput
    $pageSize: Int
    $page: Int = -1
    $offset: Int
  ) {
...
export const StanfordEventsPastEventsDocument = gql`
  query stanfordEventsPastEvents(
    $contextualFilters: StanfordEventsPastEventsContextualFilterInput
    $pageSize: Int = -1
    $page: Int
    $offset: Int
  ) {
...
export const StanfordNewsDocument = gql`
  query stanfordNews(
    $contextualFilters: StanfordNewsContextualFilterInput
    $pageSize: Int = -1
    $page: Int
    $offset: Int
  ) {
...
export const StanfordPersonDocument = gql`
  query stanfordPerson(
    $contextualFilters: StanfordPersonContextualFilterInput
    $pageSize: Int
    $page: Int = -1
    $offset: Int
  ) {
...
export const StanfordPublicationsDocument = gql`
  query stanfordPublications(
    $contextualFilters: StanfordPublicationsContextualFilterInput
    $pageSize: Int = -1
    $page: Int
    $offset: Int
  ) {
...
export const StanfordSharedTagsDocument = gql`
  query stanfordSharedTags(
    $contextualFilters: StanfordSharedTagsContextualFilterInput
    $pageSize: Int = 3
    $page: Int
    $offset: Int
  ) {
...
export const SupBooksDocument = gql`
  query supBooks(
    $contextualFilters: SupBooksViewContextualFilterInput
    $filters: SupBooksViewFilterInput
    $pageSize: Int = 3
    $page: Int
    $offset: Int
    $sortKey: SupBooksViewSortKeys
  ) {
    supBooksView(
      contextualFilter: $contextualFilters
      filter: $filters
...
export const SupBooksAwardWinnersDocument = gql`
  query supBooksAwardWinners(
    $contextualFilters: SupBooksAwardWinnersContextualFilterInput
    $filters: SupBooksAwardWinnersFilterInput
    $pageSize: Int = 3
    $page: Int
    $offset: Int
  ) {
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    Node(
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.NodeQuery>({
    ...
    BooksAuthors(
      variables?: DrupalTypes.BooksAuthorsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"]
    ): Promise<DrupalTypes.BooksAuthorsQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.BooksAuthorsQuery>({
            document: BooksAuthorsDocument,
            variables,
            requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
            signal,
          }),
    ...
    BooksWorkId(
      variables?: DrupalTypes.BooksWorkIdQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"]
    ): Promise<DrupalTypes.BooksWorkIdQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.BooksWorkIdQuery>({
            document: BooksWorkIdDocument,
            variables,
            requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
            signal,
          }),
    ...
    Courses(
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.CoursesQuery>({
    ...
    Events(
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.EventsQuery>({
    ...
    News(
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.NewsQuery>({
    ...
    People(
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.PeopleQuery>({
    ...
    Media(
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.MediaQuery>({
    ...
    Term(
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.TermQuery>({
    ...
    BookPrice(
      variables: DrupalTypes.BookPriceQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"]
    ): Promise<DrupalTypes.BookPriceQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.BookPriceQuery>({
            document: BookPriceDocument,
            variables,
            requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
            signal,
          }),
    ...
    Menu(
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.MenuQuery>({
    ...
    Route(
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.RouteQuery>({
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.StanfordBasicPagesQuery>({
            document: StanfordBasicPagesDocument,
            variables,
            requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
            signal,
          }),
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.StanfordCoursesQuery>({
            document: StanfordCoursesDocument,
            variables,
            requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
            signal,
          }),
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.StanfordEventsQuery>({
            document: StanfordEventsDocument,
            variables,
            requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
            signal,
          }),
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.StanfordEventsPastEventsQuery>({
            document: StanfordEventsPastEventsDocument,
            variables,
            requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
            signal,
          }),
    ...
    stanfordNews(
      variables?: DrupalTypes.StanfordNewsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"]
    ): Promise<DrupalTypes.StanfordNewsQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.StanfordNewsQuery>({
            document: StanfordNewsDocument,
            variables,
            requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
            signal,
          }),
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.StanfordPersonQuery>({
            document: StanfordPersonDocument,
            variables,
            requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
            signal,
          }),
    ...
    stanfordPublications(
      variables?: DrupalTypes.StanfordPublicationsQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"]
    ): Promise<DrupalTypes.StanfordPublicationsQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.StanfordPublicationsQuery>({
            document: StanfordPublicationsDocument,
            variables,
            requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
            signal,
          }),
      ...
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.StanfordSharedTagsQuery>({
            document: StanfordSharedTagsDocument,
            variables,
            requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
            signal,
          }),
    ...
    supBooks(
      variables?: DrupalTypes.SupBooksQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"]
    ): Promise<DrupalTypes.SupBooksQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.SupBooksQuery>({
            document: SupBooksDocument,
            variables,
            requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
            signal,
          }),
    ...
    supBooksAwardWinners(
      variables?: DrupalTypes.SupBooksAwardWinnersQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"]
    ): Promise<DrupalTypes.SupBooksAwardWinnersQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.SupBooksAwardWinnersQuery>({
            document: SupBooksAwardWinnersDocument,
            variables,
            requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
            signal,
          }),
    ...
    supBookAncillary(
      variables?: DrupalTypes.SupBookAncillaryQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"]
    ): Promise<DrupalTypes.SupBookAncillaryQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.SupBookAncillaryQuery>({
            document: SupBookAncillaryDocument,
            variables,
            requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
            signal,
          }),
    ...
    supBooksBestSellers(
      variables?: DrupalTypes.SupBooksBestSellersQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"]
    ): Promise<DrupalTypes.SupBooksBestSellersQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.SupBooksBestSellersQuery>({
            document: SupBooksBestSellersDocument,
            variables,
            requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
            signal,
          }),
    ...
    supBooksNewReleases(
      variables?: DrupalTypes.SupBooksNewReleasesQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
      signal?: RequestInit["signal"]
    ): Promise<DrupalTypes.SupBooksNewReleasesQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<DrupalTypes.SupBooksNewReleasesQuery>({
            document: SupBooksNewReleasesDocument,
            variables,
            requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
            signal,
          }),

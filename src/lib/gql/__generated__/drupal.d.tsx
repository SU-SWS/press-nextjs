...
export type MediaImage = MediaInterface &
  MetaTagInterface & {
    ...
    status: Scalars["Boolean"]["output"]
    /** Book Work ID Number */
    supBookWorkId?: Maybe<Scalars["Int"]["output"]>
    /** The Universally Unique IDentifier (UUID). */
    uuid: Scalars["ID"]["output"]
  }
...
export type MediaSupProtectedFile = MediaInterface &
  MetaTagInterface & {
    ...
    supMediaFile: File
    /** Group Access */
    supMediaFileGroup: TermSupFileGroup
    /** The Universally Unique IDentifier (UUID). */
    uuid: Scalars["ID"]["output"]
  }
...
export type NodeSupBookAncillary = EdgeNode &
  ...
  NodeInterface & {
    ...
    /**
     * Sort order relative to other excerpt pages on the same book. The lower the
     * number, the higher the priority. 0 weights will appear first. Similar weights
     * will be sorted alphabetically.
     */
    supAncillaryWeight?: Maybe<Scalars["Int"]["output"]>
    /** Title */
    title: Scalars["String"]["output"]
    /** The Universally Unique IDentifier (UUID). */
    uuid: Scalars["ID"]["output"]
...
export type StanfordBasicSiteSetting = ConfigPagesInterface &
  ...
  MetaTagInterface & {
    ...
    /** FileMaker API Client Secret */
    supFilemakerPass?: Maybe<Scalars["String"]["output"]>
    /** FileMaker API Client ID */
    supFilemakerUser?: Maybe<Scalars["String"]["output"]>
    /** The Universally Unique IDentifier (UUID). */
    uuid: Scalars["ID"]["output"]
  }
...
export type TermSupBookSubject = MetaTagInterface &
  TermInterface & {
    ...
    status: Scalars["Boolean"]["output"]
    /** Subject hash */
    supSubjectHash?: Maybe<Scalars["String"]["output"]>
    /** The Universally Unique IDentifier (UUID). */
    uuid: Scalars["ID"]["output"]
    /** The weight of this term in relation to other terms. */
    weight: Scalars["Int"]["output"]
...
/** Entity type taxonomy_term. */
export type TermSupBookTag = MetaTagInterface &
  TermInterface & {
    __typename?: "TermSupBookTag"
    /** The time that the term was last edited. */
    changed: DateTime
    /** Description */
    description: Text
...
/** Entity type taxonomy_term. */
export type TermSupFileGroup = MetaTagInterface &
  TermInterface & {
    __typename?: "TermSupFileGroup"
    /** The time that the term was last edited. */
    changed: DateTime
    /** Description */
    description: Text
  ...
  node?:
    | {
        ...
        suCourseQuarters?: Array<{
          ...
          parent?:
            ...
            | {__typename?: "TermSupBookSubject"; uuid: string}
            | {__typename?: "TermSupBookTag"; uuid: string}
            | {__typename?: "TermSupFileGroup"; uuid: string}
            | {__typename?: "TermSupImprint"; uuid: string}
            | {__typename?: "TermSupSeries"; uuid: string}
            | null
        }> | null
        suCourseSubject?: {
          __typename: "TermSuCourseSubject"
    ...
    | {
        ...
        suEventComponents?: Array<
          ...
          | {
              ...
              suEntityItem?: Array<
                | {__typename?: "NodeStanfordCourse"; uuid: string; path?: string | null}
                | {__typename?: "NodeStanfordEvent"; uuid: string; path?: string | null}
                | {__typename?: "NodeStanfordEventSeries"; uuid: string; path?: string | null}
                | {__typename?: "NodeStanfordMedia"; uuid: string; path?: string | null}
                | {__typename?: "NodeStanfordNews"; uuid: string; path?: string | null}
                | {__typename?: "NodeStanfordOpportunity"; uuid: string; path?: string | null}
                | {__typename?: "NodeStanfordPage"; uuid: string; path?: string | null}
                | {__typename?: "NodeStanfordPerson"; uuid: string; path?: string | null}
                ...
                | {__typename?: "NodeSupBook"; uuid: string; path?: string | null}
              > | null
            }
          | {
              __typename: "ParagraphStanfordFaq"
    ...
    | {
        ...
        suPageComponents?: Array<
          ...
          | {__typename: "ParagraphSupAuthorList"; uuid: string; behaviors?: string | null; status: boolean}
          | {
              __typename: "ParagraphSupBlogTeaser"
              uuid: string
              behaviors?: string | null
          ...
          | {
              ...
              supSearchSubject?: {__typename?: "TermSupBookSubject"; uuid: string; name: string} | null
            }
        > | null
        suPageImage?: {
          __typename: "MediaImage"
    ...
    | {
        ...
        supBookEpubFormat?: boolean | null
        supBookPdfFormat?: boolean | null
        uuid: string
        title: string
        path?: string | null
        metatag: Array<
        ...
        supBookSubjects?: Array<{
          ...
          weight: number
          parent?:
            | {__typename?: "TermBasicPageType"; uuid: string; name: string}
            | {__typename?: "TermCourseFilter"; uuid: string; name: string}
            | {__typename?: "TermEventAudience"; uuid: string; name: string}
            | {__typename?: "TermEventFilter"; uuid: string; name: string}
            | {__typename?: "TermMediaContentFilter"; uuid: string; name: string}
            | {__typename?: "TermMediaContentType"; uuid: string; name: string}
            | {__typename?: "TermOpportunitySponsor"; uuid: string; name: string}
            | {__typename?: "TermOpportunityTagFilter"; uuid: string; name: string}
            | {__typename?: "TermOpportunityType"; uuid: string; name: string}
            | {__typename?: "TermOpportunityUnit"; uuid: string; name: string}
            | {__typename?: "TermPersonFilter"; uuid: string; name: string}
            | {__typename?: "TermPublicationFilter"; uuid: string; name: string}
            | {__typename?: "TermStanfordEventGroup"; uuid: string; name: string}
            | {__typename?: "TermStanfordEventKeyword"; uuid: string; name: string}
            | {__typename?: "TermStanfordEventSubject"; uuid: string; name: string}
            | {__typename?: "TermStanfordEventType"; uuid: string; name: string}
            | {__typename?: "TermStanfordNewsSpotlightFilter"; uuid: string; name: string}
            | {__typename?: "TermStanfordNewsTopic"; uuid: string; name: string}
            | {__typename?: "TermStanfordPersonType"; uuid: string; name: string}
            | {__typename?: "TermStanfordPublicationTopic"; uuid: string; name: string}
            | {__typename?: "TermSuCourseQuarter"; uuid: string; name: string}
            | {__typename?: "TermSuCourseSubject"; uuid: string; name: string}
            | {__typename?: "TermSuCourseTag"; uuid: string; name: string}
            | {__typename?: "TermSuSharedTag"; uuid: string; name: string}
            | {__typename?: "TermSupBookSubject"; uuid: string; name: string}
            | {__typename?: "TermSupBookTag"; uuid: string; name: string}
            | {__typename?: "TermSupFileGroup"; uuid: string; name: string}
            | {__typename?: "TermSupImprint"; uuid: string; name: string}
            | {__typename?: "TermSupSeries"; uuid: string; name: string}
            | null
        }> | null
        supBookERetailers?: Array<{__typename?: "Link"; title?: string | null; url?: string | null}> | null
        supBookPriceData?: {__typename?: "PressPrice"; supIntlCart?: boolean | null; uuid: string} | null
      }
    | {
        __typename: "NodeSupBookAncillary"
        status: boolean
...
export type BooksWorkIdQuery = {
  ...
  nodeSupBooks: {
    __typename?: "NodeSupBookConnection"
    nodes: Array<{__typename?: "NodeSupBook"; path?: string | null; supBookWorkIdNumber?: number | null}>
    pageInfo: {__typename?: "ConnectionPageInfo"; hasNextPage: boolean; endCursor?: any | null}
  }
}
...
export type ParagraphQuery = {
  ...
  paragraph?:
    ...
    | {__typename: "ParagraphSupAuthorList"; uuid: string; behaviors?: string | null; status: boolean}
    | {__typename: "ParagraphSupBlog"; uuid: string; behaviors?: string | null; status: boolean}
    | {
        __typename: "ParagraphSupBlogTeaser"
        uuid: string
        behaviors?: string | null
    ...
    | {__typename: "ParagraphSupCarouselSlide"; uuid: string; behaviors?: string | null; status: boolean}
    | {
        __typename: "ParagraphSupFileList"
        uuid: string
        behaviors?: string | null
...
type FragmentTermInterface_TermSupBookTag_Fragment = {
  __typename: "TermSupBookTag"
  uuid: string
  name: string
  path?: string | null
...
type FragmentTermInterface_TermSupFileGroup_Fragment = {
  __typename: "TermSupFileGroup"
  uuid: string
  name: string
  path?: string | null
...
export type FragmentTermInterfaceFragment =
  ...
  | FragmentTermInterface_TermSupBookTag_Fragment
  | FragmentTermInterface_TermSupFileGroup_Fragment
...
type FragmentNodeInterface_NodeSupBook_Fragment = {
  __typename: "NodeSupBook"
  uuid: string
  title: string
  path?: string | null
...
export type FragmentNodeSupBookFragment = {
  ...
  supBookPubDateCloth?: {__typename?: "DateTime"; timezone: any; time: any} | null
  supBookPubDateFirst?: {__typename?: "DateTime"; timezone: any; time: any} | null
  supBookRelatedTitles?: Array<{__typename: "NodeSupBook"; uuid: string; title: string; path?: string | null}> | null
  supBookReviews?: {__typename?: "Text"; processed?: any | null} | null
  supBookSeries?: {
    __typename: "TermSupSeries"
    uuid: string
...
export type FragmentNodeSupBookTeaserFragment = {
  ...
  supBookAwards?: Array<{__typename?: "PressAward"; uuid: string}> | null
  supBookImage?: {
    __typename: "MediaImage"
    uuid: string
    name: string
...
export type BookPriceQuery = {
  ...
  press?:
    ...
    | {
        __typename: "PressPrice"
        uuid: string
        supAltPrice?: number | null
        supClothDiscount?: number | null
        supClothPrice?: number | null
        supClothSale?: number | null
        supComingSoon?: boolean | null
        supDigitalPrice?: number | null
        supDigitalSale?: number | null
        supDigitalDiscount?: number | null
...
export type SupBookAncillaryQuery = {
  ...
  supBookAncillary?: {
    __typename?: "SupBookAncillaryResult"
    results: Array<
      | {__typename?: "NodeStanfordCourse"; uuid: string; path?: string | null; title: string}
      | {__typename?: "NodeStanfordEvent"; uuid: string; path?: string | null; title: string}
      | {__typename?: "NodeStanfordEventSeries"; uuid: string; path?: string | null; title: string}
      | {__typename?: "NodeStanfordMedia"; uuid: string; path?: string | null; title: string}
      | {__typename?: "NodeStanfordNews"; uuid: string; path?: string | null; title: string}
      | {__typename?: "NodeStanfordOpportunity"; uuid: string; path?: string | null; title: string}
      | {__typename?: "NodeStanfordPage"; uuid: string; path?: string | null; title: string}
      | {__typename?: "NodeStanfordPerson"; uuid: string; path?: string | null; title: string}
      | {__typename?: "NodeStanfordPolicy"; uuid: string; path?: string | null; title: string}
      | {__typename?: "NodeStanfordPublication"; uuid: string; path?: string | null; title: string}
      | {__typename?: "NodeSupBook"; uuid: string; path?: string | null; title: string}
      | {__typename?: "NodeSupBookAncillary"; uuid: string; path?: string | null; title: string}
    >
  } | null
}

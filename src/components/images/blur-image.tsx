 ...
 *
 * Deriving the placeholder downloads the original from Drupal, which is slow enough to hold up the server component
 * rendering it. Putting that behind Suspense lets the surrounding page stream with a plain image immediately and swap
 * in the blurred variant once it resolves.
 */

...
export const H1 = ({children, className, ...props}: Props) => {
  return (
    <h1
      ...
      className={twMerge(
        "rs-mb-5 font-medium",
        className?.includes("type-") ? className : ["type-3 xl:text-[4.1rem]", className]
      )}
    >
      {children}
    </h1>
  ...
  return (
    <h2
      ...
      className={twMerge(
        headingLinkClasses,
        "font-medium",
        className?.includes("type-") ? className : ["type-2 xl:text-[3.3rem]", className]
      )}
    >
      {children}
    </h2>
  ...
  return (
    <h3
      ...
      className={twMerge(
        headingLinkClasses,
        "font-medium",
        className?.includes("type-") ? className : ["type-1 xl:text-26", className]
      )}
    >
      {children}
    </h3>
  ...
  return (
    <h4
      ...
      className={twMerge(
        headingLinkClasses,
        "font-bold",
        className?.includes("type-") ? className : ["type-0 xl:text-21", className]
      )}
    >
      {children}
    </h4>

...
export const Button = ({
  ...
  const standardClasses = clsx({
    ...
    "btn btn--big transition text-5xl text-white *:text-white hocus:text-white bg-digital-red hocus:bg-cardinal-red no-underline hocus:underline py-6 px-12 font-normal border-2 border-cardinal-red":
      big && !secondary,
    "btn btn--secondary transition text-stone-dark *:text-stone-dark border-2 border-fog-dark hocus:border-cardinal-red hocus:bg-cardinal-red hocus:text-white no-underline hocus:underline py-4 px-8 font-normal":
      !big && secondary,

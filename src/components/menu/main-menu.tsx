    ...
    >
      <div className="flex items-center justify-between lg:justify-end">
        ...
        {(children.length > 0 && level < menuLevelsToShow) &&
          <>
            {level === 0 && <div className="lg:hidden block ml-5 w-[1px] h-[25px] mb-[6px] bg-archway-light shrink-0"/>}
            <button
              ref={buttonRef}
              className="lg:hidden shrink-0 relative right-10 lg:right-0 text-white lg:text-digital-red bg-digital-red lg:bg-transparent rounded-full lg:rounded-none group border-b border-transparent hocus:border-black hocus:bg-white"

  ...
  return (
    <ImageCard {...props} aria-labelledby={node.id} isArticle>
      ...
      <div className="flex flex-col">
        <Heading className="type-1 [&_a]:text-black [&_a]:hocus:text-digital-red" id={node.id}>
      ...
      {node.suEventSubheadline && <div className="type-0 mb-5 font-bold">{node.suEventSubheadline}</div>}

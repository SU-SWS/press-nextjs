    ...
    <article className="centered mt-32" {...props}>
      <div className="mb-32 flex flex-col gap-20 lg:flex-row">
        ...
        <div className="flex flex-col">
          ...
          {node.suPersonFullTitle && <div className="type-0 order-3">{node.suPersonFullTitle}</div>}
        </div>
      </div>
      ...
      <section className="flex flex-col lg:flex-row">
        <div className="flex-1 shrink-0">
          ...
          {node.suPersonEducation && (
            <div className="mb-10">
              <H2 className="type-0">Education</H2>
          ...
          {node.suPersonResearch && (
            <div className="mb-10">
              <H2 className="type-0">Research</H2>
          ...
          {node.suPersonAffiliations && (
            <div className="mb-10">
              <H2 className="type-0">Stanford Affiliations</H2>
              <div className="grid grid-cols-2 gap-10">
